...
import { Card, CardImg, CardImgOverlay,
    CardTitle, Breadcrumb, BreadcrumbItem, CardText, CardBody, Button, CardSubtitle} from 'reactstrap';
...
function RenderBookItem ({boo, onClick,onButton,flip,current,reviews}) {
  const bo = boo.map((book) => {
          return (
            <ReactCardFlip isFlipped={flip && current === book.id } flipDirection="horizontal">
            ...
            <Card style={{ width: '25rem',minHeight:'50rem'}}>
                    ...
                    <CardBody>
                        ...
                        <Button onClick={onButton(book.id)} ><span className="fa fa-undo fa-lg"></span>Click for Reviews</Button>
                        </div>
                    </CardBody>
...
class Book extends Component {
 ...
 handleClick (text) {
  return event => {
    ...
    this.setState(prevState => ({ isFlipped: !prevState.isFlipped, current:text }));
    event.preventDefault();
  }
}
        ...
        return (
             ...
             <div className="container">
                 <div className="row">
                  ...
                  <RenderBookItem reviews={this.props.reviews} current={this.state.current} flip={this.state.isFlipped} boo={this.props.books} onClick={this.props.onClick} onButton={this.handleClick} />
               </div>
